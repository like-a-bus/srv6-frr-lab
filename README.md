...
Готовая лаба на [Containerlab](https://containerlab.dev): три роутера FRR, IS-IS с SRv6-локаторами, IPv4-трафик внутри SRv6-туннеля через `End.DT4`.
...
Четыре момента, на которых лаба разваливается молча, без единой ошибки в логах.
