# te — десять узлов, L3VPN и явные пути через SRH
...
10 узлов, 16 линков. PE1 и PE2 подключены к P1 и P2, PE3 и PE4 — к P3 и P4.
Ядро связано линками P1—P3, P2—P4, P1—P2, P3—P4: две плоскости плюс поперечины.
CE1 висит на PE1 и PE2, CE2 — на PE3 и PE4.
